...
const struct cppi41_dma_block cppi41_dma_block[CPPI41_NUM_DMA_BLOCK] = {
        [0] = {
                .global_ctrl_base = IO_ADDRESS(DA8XX_USB0_CFG_BASE) + 0x1000,
                .ch_ctrl_stat_base = IO_ADDRESS(DA8XX_USB0_CFG_BASE) + 0x1800,
                .sched_ctrl_base  = IO_ADDRESS(DA8XX_USB0_CFG_BASE) + 0x2000,
                .sched_table_base = IO_ADDRESS(DA8XX_USB0_CFG_BASE) + 0x2800,
                .num_tx_ch        = 4,
                .num_rx_ch        = 4,
...
const struct cppi41_queue_mgr cppi41_queue_mgr[CPPI41_NUM_QUEUE_MGR] = {
        [0] = {
                .q_mgr_rgn_base    = IO_ADDRESS(DA8XX_USB0_CFG_BASE) + 0x4000,
                .desc_mem_rgn_base = IO_ADDRESS(DA8XX_USB0_CFG_BASE) + 0x5000,
                .q_mgmt_rgn_base   = IO_ADDRESS(DA8XX_USB0_CFG_BASE) + 0x6000,
                .q_stat_rgn_base   = IO_ADDRESS(DA8XX_USB0_CFG_BASE) + 0x6800,
...
int __init cppi41_queue_mgr_init(u8 q_mgr, dma_addr_t rgn0_base, u16 rgn0_size)
{
	...
	__raw_writel(linking_ram[q_mgr].phys_addr, q_mgr_regs + QMGR_LINKING_RAM_RGN0_BASE_REG);
