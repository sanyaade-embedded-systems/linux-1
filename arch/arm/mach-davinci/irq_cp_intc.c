...
static u8 omapl1xx_default_priorities[DAVINCI_N_AINTC_IRQ] = {
	[IRQ_OMAPL1X7_COMMTX]              = 7,
	[IRQ_OMAPL1X7_COMMRX]              = 7,
	[IRQ_OMAPL1X7_NINT]                = 7,
	[IRQ_OMAPL1X7_EVTOUT0]             = 7,
	[IRQ_OMAPL1X7_EVTOUT1]             = 7,
	[IRQ_OMAPL1X7_EVTOUT2]             = 7,
	[IRQ_OMAPL1X7_EVTOUT3]             = 7,
	[IRQ_OMAPL1X7_EVTOUT4]             = 7,
	[IRQ_OMAPL1X7_EVTOUT5]             = 7,
	[IRQ_OMAPL1X7_EVTOUT6]             = 7,
	[IRQ_OMAPL1X7_EVTOUT7]             = 7,
	[IRQ_OMAPL1X7_CCINT0]              = 7,
	[IRQ_OMAPL1X7_CCERRINT]            = 7,
	[IRQ_OMAPL1X7_TCERRINT0]           = 7,
	[IRQ_OMAPL1X7_AEMIFINT]            = 7,
	[IRQ_OMAPL1X7_I2CINT0]             = 7,
	[IRQ_OMAPL1X7_MMCSDINT0]           = 7,
	[IRQ_OMAPL1X7_MMCSDINT1]           = 7,
	[IRQ_OMAPL1X7_ALLINT0]             = 7,
	[IRQ_OMAPL1X7_RTC]                 = 7,
	[IRQ_OMAPL1X7_SPINT0]              = 7,
	[IRQ_OMAPL1X7_TINT12_0]            = 7,
	[IRQ_OMAPL1X7_TINT34_0]            = 7,
	[IRQ_OMAPL1X7_TINT12_1]            = 7,
	[IRQ_OMAPL1X7_TINT34_1]            = 7,
	[IRQ_OMAPL1X7_UARTINT0]            = 7,
	[IRQ_OMAPL1X7_KEYMGRINT]           = 7,
	[IRQ_OMAPL1X7_SECINT]              = 7,
	[IRQ_OMAPL1X7_SECKEYERR]           = 7,
	[IRQ_OMAPL1X7_MPUERR]              = 7,
	[IRQ_OMAPL1X7_IOPUERR]             = 7,
	[IRQ_OMAPL1X7_BOOTCFGERR]          = 7,
	[IRQ_OMAPL1X7_CHIPINT0]            = 7,
	[IRQ_OMAPL1X7_CHIPINT1]            = 7,
	[IRQ_OMAPL1X7_CHIPINT2]            = 7,
	[IRQ_OMAPL1X7_CHIPINT3]            = 7,
	[IRQ_OMAPL1X7_TCERRINT1]           = 7,
	[IRQ_OMAPL1X7_C0_RX_THRESH_PULSE]  = 7,
	[IRQ_OMAPL1X7_C0_RX_PULSE]         = 7,
	[IRQ_OMAPL1X7_C0_TX_PULSE]         = 7,
	[IRQ_OMAPL1X7_C0_MISC_PULSE]       = 7,
	[IRQ_OMAPL1X7_C1_RX_THRESH_PULSE]  = 7,
	[IRQ_OMAPL1X7_C1_RX_PULSE]         = 7,
	[IRQ_OMAPL1X7_C1_TX_PULSE]         = 7,
	[IRQ_OMAPL1X7_C1_MISC_PULSE]       = 7,
	[IRQ_OMAPL1X7_MEMERR]              = 7,
	[IRQ_OMAPL1X7_GPIO0]               = 7,
	[IRQ_OMAPL1X7_GPIO1]               = 7,
	[IRQ_OMAPL1X7_GPIO2]               = 7,
	[IRQ_OMAPL1X7_GPIO3]               = 7,
	[IRQ_OMAPL1X7_GPIO4]               = 7,
	[IRQ_OMAPL1X7_GPIO5]               = 7,
	[IRQ_OMAPL1X7_GPIO6]               = 7,
	[IRQ_OMAPL1X7_GPIO7]               = 7,
	[IRQ_OMAPL1X7_GPIO8]               = 7,
	[IRQ_OMAPL1X7_I2CINT1]             = 7,
	[IRQ_OMAPL1X7_LCDINT]              = 7,
	[IRQ_OMAPL1X7_UARTINT1]            = 7,
	[IRQ_OMAPL1X7_MCASPINT]            = 7,
	[IRQ_OMAPL1X7_ALLINT1]             = 7,
	[IRQ_OMAPL1X7_SPINT1]              = 7,
	[IRQ_OMAPL1X7_UHPI_INT1]           = 7,
	[IRQ_OMAPL1X7_USB_INT]             = 7,
	[IRQ_OMAPL1X7_IRQN]                = 7,
	[IRQ_OMAPL1X7_RWAKEUP]             = 7,
	[IRQ_OMAPL1X7_UARTINT2]            = 7,
	[IRQ_OMAPL1X7_DFTSSINT]            = 7,
	[IRQ_OMAPL1X7_EHRPWM0]             = 7,
	[IRQ_OMAPL1X7_EHRPWM0TZ]           = 7,
	[IRQ_OMAPL1X7_EHRPWM1]             = 7,
	[IRQ_OMAPL1X7_EHRPWM1TZ]           = 7,
	[IRQ_OMAPL1X7_EHRPWM2]             = 7,
	[IRQ_OMAPL1X7_EHRPWM2TZ]           = 7,
	[IRQ_OMAPL1X7_ECAP0]               = 7,
	[IRQ_OMAPL1X7_ECAP1]               = 7,
	[IRQ_OMAPL1X7_ECAP2]               = 7,
	[IRQ_OMAPL1X7_EQEP0]               = 7,
	[IRQ_OMAPL1X7_EQEP1]               = 7,
	[IRQ_OMAPL1X7_T12CMPINT0_0]        = 7,
	[IRQ_OMAPL1X7_T12CMPINT1_0]        = 7,
	[IRQ_OMAPL1X7_T12CMPINT2_0]        = 7,
	[IRQ_OMAPL1X7_T12CMPINT3_0]        = 7,
	[IRQ_OMAPL1X7_T12CMPINT4_0]        = 7,
	[IRQ_OMAPL1X7_T12CMPINT5_0]        = 7,
	[IRQ_OMAPL1X7_T12CMPINT6_0]        = 7,
	[IRQ_OMAPL1X7_T12CMPINT7_0]        = 7,
	[IRQ_OMAPL1X7_T12CMPINT0_1]        = 7,
	[IRQ_OMAPL1X7_T12CMPINT1_1]        = 7,
	[IRQ_OMAPL1X7_T12CMPINT2_1]        = 7,
	[IRQ_OMAPL1X7_T12CMPINT3_1]        = 7,
	[IRQ_OMAPL1X7_T12CMPINT4_1]        = 7,
	[IRQ_OMAPL1X7_T12CMPINT5_1]        = 7,
	[IRQ_OMAPL1X7_T12CMPINT6_1]        = 7,
	[IRQ_OMAPL1X7_T12CMPINT7_1]        = 7,
	[IRQ_OMAPL1X7_ARMCLKSTOPREQ]       = 7,
};
