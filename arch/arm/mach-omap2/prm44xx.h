...
#define OMAP4430_CM_WKUP_CLKSTCTRL			OMAP44XX_CM1_REGADDR(OMAP4430_PRM_WKUP_CM_MOD, 0x0000)
#define OMAP4_CM_WKUP_L4WKUP_CLKCTRL_OFFSET		0x0020
#define OMAP4430_CM_WKUP_L4WKUP_CLKCTRL			OMAP44XX_CM1_REGADDR(OMAP4430_PRM_WKUP_CM_MOD, 0x0020)
#define OMAP4_CM_WKUP_WDT1_CLKCTRL_OFFSET		0x0028
#define OMAP4430_CM_WKUP_WDT1_CLKCTRL			OMAP44XX_CM1_REGADDR(OMAP4430_PRM_WKUP_CM_MOD, 0x0028)
#define OMAP4_CM_WKUP_WDT2_CLKCTRL_OFFSET		0x0030
#define OMAP4430_CM_WKUP_WDT2_CLKCTRL			OMAP44XX_CM1_REGADDR(OMAP4430_PRM_WKUP_CM_MOD, 0x0030)
#define OMAP4_CM_WKUP_GPIO1_CLKCTRL_OFFSET		0x0038
#define OMAP4430_CM_WKUP_GPIO1_CLKCTRL			OMAP44XX_CM1_REGADDR(OMAP4430_PRM_WKUP_CM_MOD, 0x0038)
#define OMAP4_CM_WKUP_TIMER1_CLKCTRL_OFFSET		0x0040
#define OMAP4430_CM_WKUP_TIMER1_CLKCTRL			OMAP44XX_CM1_REGADDR(OMAP4430_PRM_WKUP_CM_MOD, 0x0040)
#define OMAP4_CM_WKUP_TIMER12_CLKCTRL_OFFSET		0x0048
#define OMAP4430_CM_WKUP_TIMER12_CLKCTRL		OMAP44XX_CM1_REGADDR(OMAP4430_PRM_WKUP_CM_MOD, 0x0048)
#define OMAP4_CM_WKUP_SYNCTIMER_CLKCTRL_OFFSET		0x0050
#define OMAP4430_CM_WKUP_SYNCTIMER_CLKCTRL		OMAP44XX_CM1_REGADDR(OMAP4430_PRM_WKUP_CM_MOD, 0x0050)
#define OMAP4_CM_WKUP_USIM_CLKCTRL_OFFSET		0x0058
#define OMAP4430_CM_WKUP_USIM_CLKCTRL			OMAP44XX_CM1_REGADDR(OMAP4430_PRM_WKUP_CM_MOD, 0x0058)
#define OMAP4_CM_WKUP_SARRAM_CLKCTRL_OFFSET		0x0060
#define OMAP4430_CM_WKUP_SARRAM_CLKCTRL			OMAP44XX_CM1_REGADDR(OMAP4430_PRM_WKUP_CM_MOD, 0x0060)
#define OMAP4_CM_WKUP_KEYBOARD_CLKCTRL_OFFSET		0x0078
#define OMAP4430_CM_WKUP_KEYBOARD_CLKCTRL		OMAP44XX_CM1_REGADDR(OMAP4430_PRM_WKUP_CM_MOD, 0x0078)
#define OMAP4_CM_WKUP_RTC_CLKCTRL_OFFSET		0x0080
#define OMAP4430_CM_WKUP_RTC_CLKCTRL			OMAP44XX_CM1_REGADDR(OMAP4430_PRM_WKUP_CM_MOD, 0x0080)
#define OMAP4_CM_WKUP_BANDGAP_CLKCTRL_OFFSET		0x0088
#define OMAP4430_CM_WKUP_BANDGAP_CLKCTRL		OMAP44XX_CM1_REGADDR(OMAP4430_PRM_WKUP_CM_MOD, 0x0088)
...
#define OMAP4430_CM_EMU_CLKSTCTRL			OMAP44XX_CM1_REGADDR(OMAP4430_PRM_EMU_CM_MOD, 0x0000)
#define OMAP4_CM_EMU_DYNAMICDEP_OFFSET			0x0008
#define OMAP4430_CM_EMU_DYNAMICDEP			OMAP44XX_CM1_REGADDR(OMAP4430_PRM_EMU_CM_MOD, 0x0008)
#define OMAP4_CM_EMU_DEBUGSS_CLKCTRL_OFFSET		0x0020
#define OMAP4430_CM_EMU_DEBUGSS_CLKCTRL			OMAP44XX_CM1_REGADDR(OMAP4430_PRM_EMU_CM_MOD, 0x0020)
...
#define OMAP4430_REVISION_PRCM				OMAP44XX_PRM_REGADDR(OMAP4430_PRCM_MPU_OCP_SOCKET_PRCM_MOD, 0x0000)

/* PRCM_MPU.DEVICE_PRM register offsets */
#define OMAP4_PRCM_MPU_PRM_RSTST_OFFSET			0x0000
#define OMAP4430_PRCM_MPU_PRM_RSTST			OMAP44XX_PRM_REGADDR(OMAP4430_PRCM_MPU_DEVICE_PRM_MOD, 0x0000)
#define OMAP4_PRCM_MPU_PRM_PSCON_COUNT_OFFSET		0x0004
#define OMAP4430_PRCM_MPU_PRM_PSCON_COUNT		OMAP44XX_PRM_REGADDR(OMAP4430_PRCM_MPU_DEVICE_PRM_MOD, 0x0004)

/* PRCM_MPU.CPU0 register offsets */
#define OMAP4_PM_CPU0_PWRSTCTRL_OFFSET			0x0000
#define OMAP4430_PM_CPU0_PWRSTCTRL			OMAP44XX_PRM_REGADDR(OMAP4430_PRCM_MPU_CPU0_MOD, 0x0000)
#define OMAP4_PM_CPU0_PWRSTST_OFFSET			0x0004
#define OMAP4430_PM_CPU0_PWRSTST			OMAP44XX_PRM_REGADDR(OMAP4430_PRCM_MPU_CPU0_MOD, 0x0004)
#define OMAP4_RM_CPU0_CPU0_CONTEXT_OFFSET		0x0008
#define OMAP4430_RM_CPU0_CPU0_CONTEXT			OMAP44XX_PRM_REGADDR(OMAP4430_PRCM_MPU_CPU0_MOD, 0x0008)
#define OMAP4_RM_CPU0_CPU0_RSTCTRL_OFFSET		0x000c
#define OMAP4430_RM_CPU0_CPU0_RSTCTRL			OMAP44XX_PRM_REGADDR(OMAP4430_PRCM_MPU_CPU0_MOD, 0x000c)
#define OMAP4_RM_CPU0_CPU0_RSTST_OFFSET			0x0010
#define OMAP4430_RM_CPU0_CPU0_RSTST			OMAP44XX_PRM_REGADDR(OMAP4430_PRCM_MPU_CPU0_MOD, 0x0010)
#define OMAP4_CM_CPU0_CPU0_CLKCTRL_OFFSET		0x0014
#define OMAP4430_CM_CPU0_CPU0_CLKCTRL			OMAP44XX_PRM_REGADDR(OMAP4430_PRCM_MPU_CPU0_MOD, 0x0014)
#define OMAP4_CM_CPU0_CLKSTCTRL_OFFSET			0x0018
#define OMAP4430_CM_CPU0_CLKSTCTRL			OMAP44XX_PRM_REGADDR(OMAP4430_PRCM_MPU_CPU0_MOD, 0x0018)

/* PRCM_MPU.CPU1 register offsets */
#define OMAP4_PM_CPU1_PWRSTCTRL_OFFSET			0x0000
#define OMAP4430_PM_CPU1_PWRSTCTRL			OMAP44XX_PRM_REGADDR(OMAP4430_PRCM_MPU_CPU1_MOD, 0x0000)
#define OMAP4_PM_CPU1_PWRSTST_OFFSET			0x0004
#define OMAP4430_PM_CPU1_PWRSTST			OMAP44XX_PRM_REGADDR(OMAP4430_PRCM_MPU_CPU1_MOD, 0x0004)
#define OMAP4_RM_CPU1_CPU1_CONTEXT_OFFSET		0x0008
#define OMAP4430_RM_CPU1_CPU1_CONTEXT			OMAP44XX_PRM_REGADDR(OMAP4430_PRCM_MPU_CPU1_MOD, 0x0008)
#define OMAP4_RM_CPU1_CPU1_RSTCTRL_OFFSET		0x000c
#define OMAP4430_RM_CPU1_CPU1_RSTCTRL			OMAP44XX_PRM_REGADDR(OMAP4430_PRCM_MPU_CPU1_MOD, 0x000c)
#define OMAP4_RM_CPU1_CPU1_RSTST_OFFSET			0x0010
#define OMAP4430_RM_CPU1_CPU1_RSTST			OMAP44XX_PRM_REGADDR(OMAP4430_PRCM_MPU_CPU1_MOD, 0x0010)
#define OMAP4_CM_CPU1_CPU1_CLKCTRL_OFFSET		0x0014
#define OMAP4430_CM_CPU1_CPU1_CLKCTRL			OMAP44XX_PRM_REGADDR(OMAP4430_PRCM_MPU_CPU1_MOD, 0x0014)
#define OMAP4_CM_CPU1_CLKSTCTRL_OFFSET			0x0018
#define OMAP4430_CM_CPU1_CLKSTCTRL			OMAP44XX_PRM_REGADDR(OMAP4430_PRCM_MPU_CPU1_MOD, 0x0018)
#endif
