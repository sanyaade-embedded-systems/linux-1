 ...
 * @in_pix: Input pixel format details in v4l2_pix_format structure.
 * @out_pix: Output pixel format details in v4l2_pix_format structure.
 * @csia_in_w: CSIA Rx input width.
 * @csia_in_h: CSIA Rx input height.
 * @csia_out_w: CSIA Rx output width (with extra padding pixels).
 * @csia_out_h: CSIA Rx output height.
 * @csia_out_w_img: CSIA Rx output width.
 * @csia_out: CSIA output destination.
