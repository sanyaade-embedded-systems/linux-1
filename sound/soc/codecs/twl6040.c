...
#define SOC_TWL6040_DOUBLE_TLV(xname, xreg, shift_left, shift_right, xmax, xinvert, tlv_array) \
...
static const struct snd_soc_dapm_widget twl6040_dapm_widgets[] = {
	...
	SND_SOC_DAPM_DRV_E("Handsfree Right Driver",
			...
			pga_event,
			SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
	SND_SOC_DAPM_DRV_E("Headset Left Driver",
			TWL6040_REG_HSLCTL, 2, 0, NULL, 0,
			pga_event,
			SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
	SND_SOC_DAPM_DRV_E("Headset Right Driver",
