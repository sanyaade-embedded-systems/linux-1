...
#define TWL6030_AUDPWRON_GPIO	11
	...
	struct snd_pcm_hw_params *params)
{
	...
	ret = snd_soc_dai_set_fmt(codec_dai, SND_SOC_DAIFMT_TI_PDM);
	if (ret < 0) {
	...
	ret = snd_soc_dai_set_fmt(cpu_dai, SND_SOC_DAIFMT_TI_PDM);
	if (ret < 0) {
...
static struct snd_soc_device sdp4430_snd_devdata = {
	...
	.codec_dev = &soc_codec_dev_twl6030,
